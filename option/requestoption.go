...
// RequestOption is an option for the requests made by the studio-sdk API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/studio-sdk-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://api.clearstreet.io/studio/v2/")
}
